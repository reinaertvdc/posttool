		 ...
		 Switch $iMsg
			...
			Case $idConfirm
			   ...
			   If _FormCheck() Then
				  ...
				  ;EndIf
				  IniWrite($sSettingsFile, "Bestemmeling", "Organisatie", $sToOrg)
				  IniWrite($sSettingsFile, "Bestemmeling", "Aanspreking", $sToSalution)
				  IniWrite($sSettingsFile, "Bestemmeling", "Voornaam", $sToFirstName)
				  IniWrite($sSettingsFile, "Bestemmeling", "Achternaam", $sToSurname)
				  IniWrite($sSettingsFile, "Bestemmeling", "Straatnaam", $sToStreet)
				  IniWrite($sSettingsFile, "Bestemmeling", "Huisnummer", $sToNumber)
				  IniWrite($sSettingsFile, "Bestemmeling", "Bus", $sToBus)
				  IniWrite($sSettingsFile, "Bestemmeling", "Postcode", $sToPostcode)
				  IniWrite($sSettingsFile, "Bestemmeling", "Gemeente", $sToCity)
				  IniWrite($sSettingsFile, "Bestemmeling", "Land", $sToCountry)
